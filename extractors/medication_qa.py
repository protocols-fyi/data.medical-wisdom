...
DATASET_FILE = Path(
    "datasets.original/medication_qa/Medication_QA_MedInfo2019-master/MedInfo2019-QA-Medications.xlsx"
)
...
def cli(dry_run: bool, limit: int | None) -> None:
    ...
    for question in tqdm(selected, total=total, desc="medication_qa", unit="record"):
